...
import { AdditionalItemsDrawer } from './AdditionalItemsDrawer';
import { Badge } from '../../ui/Badge';
import { Tooltip, TooltipTrigger, TooltipContent } from '../../ui/Tooltip';
import { Info, Utensils, PlusCircle } from 'lucide-react';
...
export default function DashboardKPIsBlock({ isLoading = false }) {
    ...
    const handleKpiClick = (label, actionId) => {
        ...
        if (actionId === 'dashboard.kpi.open.additionalItems') {
            setSelectedKpi('additional');
        }
    };
