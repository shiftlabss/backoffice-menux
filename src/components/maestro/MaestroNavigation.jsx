...
export function MaestroBreadcrumbs() {
  ...
  return (
    <div className="flex items-center text-xs font-medium text-muted-foreground/80 tracking-wide uppercase mb-6">
      <span className="hover:text-foreground/80 transition-colors cursor-default">Maestro</span>
      <span className="mx-2 text-border">/</span>
      <span className="text-purple-600 bg-purple-50 px-2 py-0.5 rounded-full border border-purple-100/50">
